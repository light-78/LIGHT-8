...
const vcard = 'BEGIN:VCARD\n' 
            + 'VERSION:3.0\n' 
            + 'LIGHT:BOT😎🤙🏻\n' 
            + 'ORG:Creador De LIGHT-BOT-V8\n' 
            + 'TEL;type=CELL;type=VOICE;waid=33660217049+33 6 60 21 70 49\n' 
            + 'END:VCARD'
//WhatsApp Conexión
const
	{
...
//SETTING
       ...
       const kapankah = ['Otro día','Otra semana','Otro mes','Otro año']
		...
		mess = {
			...
			wrongFormat: '「 ❗ 」 Wey No Seas down Escribe Bien El Formato',
